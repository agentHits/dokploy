	...
	(
		...
		return (
			...
			>
				<div
					className={cn(
						"duration-200 sticky top-0 z-10 flex h-svh w-[--sidebar-width] shrink-0 transition-[width] ease-out",
...
>(({ className, ...props }, ref) => {
	return (
		<main
			ref={ref}
			className={cn(
				"relative flex min-h-svh min-w-0 flex-1 overflow-auto flex-col bg-background",
